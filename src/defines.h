/* FIX Niklas OpenMPI */ // ND 05/04/18
#include <mpi.h>
...
#define DELETE_PARTICLE_IF_V_EXCEEDS 30
...
#define ION_DENSITY id_scratch_scalar
#define ION_VELOCITY id_scratch_vector
