...
D_REAL CBlock::getIonProdRateAtPoint(PARTICLE_REAL *r_intern,INT32 * cell_indices, INT32 ion_species, INT32 neutral_species) {
	...
	IonProdRate = PhotoionisationRate[ion_species][neutral_species]*pickScalarFieldValue(id_density_ionProdSpecies1 + neutral_species, r_intern ,  cell_indices);
#elif 	defined(use_neutral_species_as_field)
...
D_REAL CBlock::getNeutralDensityAtPoint(PARTICLE_REAL *r_intern,INT32 * cell_indices, INT32 neutral_species) {
	...
	D_REAL NeutralDensity;
	
#if defined(use_neutral_species_as_field)	
        NeutralDensity = pickScalarFieldValue(id_numberdensity_neutralSpecies1 + neutral_species, r_intern ,  cell_indices);
#endif	
