...
// 	req_is_MPI_send_completed[direc].Wait();
	...
	//! -> easy to try
//	req_is_MPI_send_completed[id_request] = mpi_myComm->IB_OR_IS_SEND(MPiC_Info_package, // from .IB_OR.... to -> ND 05/04/18
//									 num_entries_in_InfoPackage *sizeof(INT32),
//								//	 MPI::BYTE,// INT,
//									 MPI_BYTE,// ND 05/04/18
//									 dest_process,
//									 id_package);

// Fix try ND 05/04/18 // TODO: Debugging option
...
//	mpi_myComm->Recv(MPiC_Info_package, // from .Recv.... to -> ND 05/04/18
//			num_entries_in_InfoPackage *sizeof(INT32),
//		//	MPI::BYTE,
//			MPI_BYTE, //ND 05/04/18
//			src_process,
				     ...
				     INT32* &MPiC_Info_package)
{
	...
	//! since neighbour is not handled by this process, memory has not been allocated yet
	particle_package = new particle[num_particle_in_PartPackage + 1];


	//!  receive particle package
//	mpi_myComm->Recv(particle_package, // from .Recv.... to -> ND 05/04/18
//			num_particle_in_PartPackage *sizeof(particle),
		//	MPI::BYTE,
//			MPI_BYTE, // ND 05/04/18
//			src_process,
