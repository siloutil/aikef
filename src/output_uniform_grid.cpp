...
void init_GridInfo_Structure(SGrid_Info* Grid_Info, int TL)
{
	...
	//! v in m/s
        ...
        Grid_Info->Length[0] = LX/uniform_grid_shrink_domain[0];
        Grid_Info->Length[1] = LY/uniform_grid_shrink_domain[1];
        Grid_Info->Length[2] = LZ/uniform_grid_shrink_domain[2];
