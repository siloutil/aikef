...
//		Mq_r is quadrupole moment. r_7 is used for quadrupole
		D_REAL Mq_r = (   position[0] *(Magnetic_Moment_Quad[0])
				+position[1] *(Magnetic_Moment_Quad[1])
				+position[2] *(Magnetic_Moment_Quad[2]));
		D_REAL r_7 = r*r*r*r*r*r*r;
		
		Vector[0] = (5.*(Mq_r)*position[0]*position[2])/r_7 -Magnetic_Moment_Quad[0]*position[0]/r_5 + Vector[0];
		Vector[1] = (5.*(Mq_r)*position[1]*position[2])/r_7 -Magnetic_Moment_Quad[1]*position[1]/r_5 + Vector[1];
		Vector[2] = (5.*(Mq_r)*position[2]*position[2])/r_7 -3.*Magnetic_Moment_Quad[2]*position[2]/r_5  + Vector[2];
