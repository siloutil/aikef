...
extern const D_REAL neutral_torus_density;
...
extern const INT32 TL_change_dens_start;
//! number of time steps for linear change in density
extern const INT32 Num_TL_change_dens;
//! final density
extern const D_REAL rho_sw_final[];
...
//! (so far it points in z direction)
extern const D_REAL Magnetic_Moment_Quad[3];
